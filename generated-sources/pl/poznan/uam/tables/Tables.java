...
public class Tables extends TableImpl<TablesRecord> {
    ...
    private static final long serialVersionUID = -749066574;
     ...
     */
    public final TableField<TablesRecord, String> SHAPE = createField("shape", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");

    /**
     * The column <code>public.tables.name</code>.
     */
    public final TableField<TablesRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(65).nullable(false), this, "");
